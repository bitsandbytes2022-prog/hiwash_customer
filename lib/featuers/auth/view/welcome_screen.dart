        ...
        body: Stack(
          ...
          children: [
            Obx(() {
              return BgWidget(
                imagePath:
                authController.backgroundImages[authController.currentPage.value],
              );
            }),
            Positioned(
              bottom: 0,
                      ...
                      children: [
                        ...
                        Obx(() {
                          return AnimatedSmoothIndicator(
                            ...
                            count: controller.headingText.length,
                        ...
                        GestureDetector(
                          onTap: () async {
                            String url =
                                "https://loyaltyapistaging.pipelinedns.com/api/content/customerterms.html";
                            if (!await launchUrl(Uri.parse(url))) {
                              throw Exception(
                                  '${StringConstant.kCouldNotLaunch.tr} $url');
                            }
                          },
                          child: Text(
        ...
        body: Stack(
          ...
          children: [
            Obx(() {
              return BgWidget(
                imagePath:
                    authController.backgroundImages[authController
                        .currentPage
                        .value],
              );
            }),
