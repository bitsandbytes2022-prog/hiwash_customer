...
class LocationData {
  ...
  dynamic country;
  double? distanceInKm;
  List<LocationHours>? locationHours;
  ...
  LocationData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['locationHours'] != null) {
      locationHours = <LocationHours>[];
      json['locationHours'].forEach((v) {
        locationHours!.add(new LocationHours.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.locationHours != null) {
      data['locationHours'] =
          this.locationHours!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class LocationHours {
  ...
  LocationHours(
      {this.dayName, this.openingTime, this.closingTime, this.isClosed});

  LocationHours.fromJson(Map<String, dynamic> json) {
